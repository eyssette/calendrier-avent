...
function processText2quiz(content) {
	content = content.replace(
		...
		function (match, source) {
			...
			return `<iframe class="iframeText2quiz" src="https://text2quiz.vercel.app/?v=1.0&dm=0&dh=0&dqt=0&dbg=0&${theme}#${source}" style="visibility:hidden"></iframe>`;
		},
	);
	return content;
}
